...
export const PostSitesPage = () => (
  <EntityCrudPage
    ...
    fields={[
      ...
      { key: 'geo_map', type: 'map', label: 'Location (search an address, drag the pin, or type coordinates)', addressKey: 'location', latKey: 'latitude', lngKey: 'longitude', radiusKey: 'geofence_radius_m' },
      { key: 'city', label: 'City' },
